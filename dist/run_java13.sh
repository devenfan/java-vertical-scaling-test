...
# ShenandoahGC (Java12)
# JAVA_OPTS1=" -XX:+UseShenandoahGC -Xlog:gc*=info:file=app_shenandoah_gc.log:tags,time,uptimemillis,level:filecount=5,filesize=128000 "

# ZGC (Java 13)
JAVA_OPTS1=" -XX:+UseZGC -Xlog:gc*=info:file=app_zgc_gc.log:uptime,level:filecount=5,filesize=128000000"
...
$JAVA_HOME/bin/java $JAVA_OPTS -jar app.jar -1 1 -1 2048 0.98
